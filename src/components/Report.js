        ...
        <div id="test" ref={printRef} style={{ overflow: "scroll" }}>
          ...
          <div id="pg7" className="report">
              ...
              <tbody>
                <tr>
                  ...
                  <td style={{ textAlign: "left", padding: "0 5px" }}>
                    Није уочена значајнија деградација изолационих система, па
                    се може проценити да су испитивани елементи спремни за
                    нормалну употребу у погону. Препорука: редовна контрола.
                  </td>
                </tr>
                <tr>
                  <td>
            ...
            <p style={{ textAlign: "left" }}>
              НМТ – напонски мерни трансофматор
            </p>
            <p style={{ textAlign: "left" }}>
              СМТ – струјни мерни трансформатор
            </p>
